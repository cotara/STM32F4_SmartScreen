...
#define PIN_LOW GPIO_ResetBits(GPIOD, GPIO_Pin_0);
#define PIN_HIGH GPIO_SetBits(GPIOD, GPIO_Pin_0);
#define READ_DS18B20_BIT GPIO_ReadInputDataBit(GPIOD, GPIO_Pin_0);
...
uint8_t ds18b20_init(const DS18B20_RESOLUTION_t resolution) {
  ...
  //RCC->APB2ENR |= RCC_APB2ENR_IOPAEN;
    ...
    RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOD, ENABLE); //Включаем тактирование GPIOE
